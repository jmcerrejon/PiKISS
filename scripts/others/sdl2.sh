...
Install_BIN_RPi(){
	...
	wget -P $HOME https://malus.exotica.org.uk/~buzz/pi/sdl/sdl2/libsdl2-dbg_2.0.3_armhf.deb
	wget -P $HOME https://malus.exotica.org.uk/~buzz/pi/sdl/sdl2/libsdl2-dev_2.0.3_armhf.deb
	wget -P $HOME https://malus.exotica.org.uk/~buzz/pi/sdl/sdl2/libsdl2_2.0.3_armhf.deb
