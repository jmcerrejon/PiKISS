...
readonly BINARY_SNES9X_URL="https://misapuntesde.com/res/snes9x_1-60.tar.gz"
readonly BINARY_BSNES_URL="https://misapuntesde.com/rpi_share/bsnes-111.8-rpi.tar.gz"
INPUT=/tmp/snes.$$
...
menu() {
    while true; do
        dialog --clear \
            ...
            BSnes "(RECOMMENDED) It focuses on performance, features, and ease of use with GUI" \
