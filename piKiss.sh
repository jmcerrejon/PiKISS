...
smGames() {
    if is_userspace_64_bits; then
        show_dialog_only_32_bits "Abbaye, AVP, Blake Stone, DX-Rebirth, EDuke32, Fallout 2, GTA, GemRB, Hexen 2, OpenClaw, Quake I-II-III, RVGL (Re-Volt), SMario64, Serious Sam, OpenXCom, Unreal Tournament, WipeOut"
    fi
